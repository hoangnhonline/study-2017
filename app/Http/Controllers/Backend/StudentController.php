...
class StudentController extends Controller
{
    ...
    */
    ...
    {   
        ...
        return view('backend.student.index', compact( 'items', 'name' ));
    }
    ...
    */
    public function edit($id)
    {
        ...
        return view('backend.student.edit', compact('detail', 'meta'));
    }
    ...
    */
    public function update(Request $request)
    {
        ...
        return redirect()->route('student.edit', $dataArr['id']);
    }
