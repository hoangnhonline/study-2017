...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      @endif
      <a class="btn btn-default btn-sm" href="{{ route('courses-part.index', ['courses_id' => $coursesDetail->id]) }}" style="margin-bottom:5px">Quay lại</a>
             ...
             <div class="form-group">
              ...
              <select class="form-control" name="courses_id" id="courses_id">                
                @if( $coursesList->count() > 0)
                  ...
                  <option value="{{ $value->id }}" {{ $value->id == $coursesDetail->id ? "selected" : "" }}>{{ $value->name }}</option>
                  @endforeach
                @endif
              </select>
            </div>     
