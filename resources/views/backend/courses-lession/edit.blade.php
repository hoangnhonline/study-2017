...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="{{ route('courses-lession.index') }}" style="margin-bottom:5px">Quay lại</a>
    ...
    <form role="form" method="POST" action="{{ route('courses-lession.update') }}" id="dataForm">
    <div class="row">
      <!-- left column -->
