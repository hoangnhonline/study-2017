...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="{{ route('quiz-cate.index') }}" style="margin-bottom:5px">Quay lại</a>
    ...
    <div class="row">
      ...
      <div class="col-md-7">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" method="POST" action="{{ route('quiz-cate.update') }}" id='dataForm'>
            {!! csrf_field() !!}
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="{{ route('quiz-cate.index')}}">Hủy</a>
            </div>
