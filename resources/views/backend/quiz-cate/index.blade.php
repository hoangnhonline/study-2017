...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ route( 'quiz-cate.index' ) }}">Loại trắc nghiệm</a></li>
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      @endif
      <a href="{{ route('quiz-cate.create') }}" class="btn btn-info btn-sm" style="margin-bottom:5px">Tạo mới</a>
      <div class="box">
          ...
          <table class="table table-bordered" id="table-list-data">
            ...
            @if( $items->count() > 0 )
              ...
              <tr id="row-{{ $item->id }}">
                ...
                <td>                  
                  <a href="{{ route( 'quiz-cate.edit', [ 'id' => $item->id ]) }}">{{ $item->name }}</a>
                ...
                <a class="btn btn-default btn-sm" href="{{ route('news-list', $item->slug ) }}" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>
                  ...
                  <a onclick="return callDelete('{{ $item->name }}','{{ route( 'quiz-cate.destroy', [ 'id' => $item->id ]) }}');" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a>
                  @endif
                </td>
              </tr> 
              @endforeach
