...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="{{ route('courses-part.index', ['courses_id' => $courses_id ]) }}" style="margin-bottom:5px">Quay lại</a>
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="{{ route('courses-part.index', ['courses_id' => $courses_id])}}">Hủy</a>
            </div>
