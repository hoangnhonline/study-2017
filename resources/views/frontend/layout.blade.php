...
<style type="text/css">
	#footer .block-info-ft {
    	background-image: url({{ $settingArr['banner_footer'] }});
	}
	#header .header-top {    
    	background-image: url({{ $settingArr['banner_header'] }});
	}
</style>
</body>
</html>